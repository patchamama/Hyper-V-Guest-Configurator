...
# ── 6. VM access configuration ───────────────────────────────────────────────
# All VM exposure / port forwarding is now handled from the web frontend
# (Target Machine → Port Exposure section). No interactive prompts needed here.
OK "VM access configuration is managed via the web UI (Target Machine panel)."
